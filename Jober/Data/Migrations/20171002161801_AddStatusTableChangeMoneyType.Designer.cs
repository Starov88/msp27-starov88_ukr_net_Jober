...
namespace Jober.Data.Migrations
{
    ...
    [Migration("20171002161801_AddStatusTableChangeMoneyType")]
    partial class AddStatusTableChangeMoneyType
    {
            ...
            modelBuilder.Entity("Jober.Models.ApplicationUser", b =>
                {
                    b.HasOne("Jober.Models.Worker", "Worker")
                        .WithOne("User")
                        .HasForeignKey("Jober.Models.ApplicationUser", "WorkerId");
                });
            ...
            modelBuilder.Entity("Jober.Models.Order", b =>
                {
                    ...
                    b.HasOne("Jober.Models.Status", "StatusId")
                        .WithMany()
